...
import { configuracion, productos, proveedores, categorias, clientes, trabajadores, usuarios, ofertas, liquidaciones, gruposProducto, olvidarCatalogoDeProductos, unificarCategorias, unificarProductos, leerDuplicadosDescartados, descartarDuplicado, revertirDescarte, codigosInternosUsados, todosLosCodigosDeBarra, productosDadosDeBaja, reactivarProducto, bitacoraAdmin } from "@/lib/datos/colecciones/catalogo";
import {
...
const COLECCIONES = {
  ...
  "quantity-offers": ofertas,
  "price-clearance": liquidaciones,
  "product-groups": gruposProducto,
  "customers": clientes,
...
export { unificarCategorias, unificarProductos, leerDuplicadosDescartados, revertirDescarte, codigosInternosUsados, todosLosCodigosDeBarra, productosDadosDeBaja, reactivarProducto };
