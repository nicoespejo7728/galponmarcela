...
/* Los rollos que acepta la D110, con el que viene en la caja primero. La
   medida se lee en el papel del rollo o en la caja, y va siempre como
   ancho × largo. */
export const ROLLOS_D110 = [
  { id: "12x40", ancho: 12, largo: 40, etiqueta: "12 × 40 mm (el que viene en la caja)" },
  { id: "12x22", ancho: 12, largo: 22, etiqueta: "12 × 22 mm" },
  { id: "14x28", ancho: 14, largo: 28, etiqueta: "14 × 28 mm" },
  { id: "14x40", ancho: 14, largo: 40, etiqueta: "14 × 40 mm" },
  { id: "15x30", ancho: 15, largo: 30, etiqueta: "15 × 30 mm" },
];

export const ROLLO_POR_OMISION = ROLLOS_D110[0];
